...
public class RunClimbUpWithTimer extends CommandBase {
  /** Creates a new ClimbUp. */
  Timer timer;
  public RunClimbUpWithTimer() {
  ...
  public void execute() {
    ...
    if(-Robot.climber.getRightClimbPosition()<Constants.maxClimbHeight && Robot.climber.getClimbSolenoid() && timer.get()>Constants.kClimbDelay) {
