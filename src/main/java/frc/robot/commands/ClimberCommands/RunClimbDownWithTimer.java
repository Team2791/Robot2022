...
public class RunClimbDownWithTimer extends CommandBase {
  /** Creates a new ClimbUp. */
  Timer timer;
  public RunClimbDownWithTimer() {
  ...
  public void execute() {
    //if(-Robot.climber.getLeftClimbPosition()<Constants.maxClimbHeight && Robot.climber.getRightClimbPosition()<Constants.maxClimbHeight && Robot.climber.getClimbSolenoid()) {
      if(-Robot.climber.getRightClimbPosition()>Constants.minClimbHeight && Robot.climber.getClimbSolenoid() && timer.get()>Constants.kClimbDelay) {
